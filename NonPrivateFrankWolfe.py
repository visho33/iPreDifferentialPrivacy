...
class PolySFW:
    ...
    #Algorithm 1 but without differential privacy
    
    def __init__(self, Z, Y, V, f, diametro, x_start): #recieve the input    
    ...
    def run(self): #runs the algorithm
        ...
        self.dim = len(self.S_Z[0]) #dimension
        ...
        self.v[0] = int(self.argmin(self.d[0]))
